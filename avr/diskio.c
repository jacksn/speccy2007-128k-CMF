...
#define SELECT() 		{ PORTB |= (1 << PB4); volatile int i; for( i = 0; i < 32; i++ ); }
#define DESELECT() 		{ PORTB &= ~(1 << PB4); volatile int i; for( i = 0; i < 32; i++ ); }

//#define SOCKPORT	(0x00)			/* Socket contact port */
...
DWORD get_fattime()
{
	return	(( 2009UL -1980 ) << 25 )	// Year = 2009
		   | ( 4UL << 21 )			// Month = Apr
		   | ( 29UL << 16 )			// Day = 29
		   | ( 19U << 11 )			// Hour = 19
		   | ( 13U << 5 )			// Min = 13
